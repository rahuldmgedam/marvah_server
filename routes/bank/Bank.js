...
const { createBank, getBankData, changeStatus, deleteBank, createBankTran, getBankTranData, deleteBankTran, updateBankTran, getBankTranDataByDate } = require("../../controller/bank/Bank")
...
router.get("/getBankTranDataByDate", getBankTranDataByDate)
